package com.cd.missedcallpro.ui
...
import com.cd.missedcallpro.screens.*
...
fun AppNavGraph(
    ...
    val state by store.state.collectAsState(
        initial = com.cd.missedcallpro.data.AppState(
            username = "",
            email = "",
            signedIn = false,
            plan = com.cd.missedcallpro.data.PlanState("",0,0,false),
            quotas = com.cd.missedcallpro.data.Quotas(0, 0),
            smsTemplate = com.cd.missedcallpro.data.Defaults.SMS_TEMPLATE,
            companyName = "",
